                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($row['product_img']) : ?>
                                        <img src="<?php echo $row['product_img']; ?>" alt="Product Image" style="max-width: 100px;">
                                    <?php else : ?>
                                        No Image
                                    <?php endif; ?>
                                </td>
                                ...
                                <td><?php if ($row['pdf']) : ?>
                                      <a href="<?php echo $row['pdf']; ?>" target="_blank"  class="btn btn-warning shadow btn-xs sharp me-1"><i class="bi bi-file-earmark-pdf-fill"></i></a>
                                    <?php else : ?>
                                       No PDF
                                    <?php endif; ?></td>
                                <td class="action-buttons">
                                    <a href="edit-product.php?id=<?php echo $row['id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class='fa fa-pencil'></i></a>
                                    <form action="delete_product.php" method="post" style="display:inline;">
                                        <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                        <button type="submit" onclick="return confirm('Are you sure, you want to delete this product?');" class="btn btn-danger shadow btn-xs sharp">
...
<!-- Include your script tags just before the closing body tag -->
